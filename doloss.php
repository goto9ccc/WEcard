...
<html lang="en">
  ...
  <body>
    <div class="container">
        <form class="form-signin" role="form" action="/doloss.php" id="new_user" method="post">
            <h4 class="form-signin-heading"><font color= 339966>一卡通挂失</font></h4>
...
{      
                ...
                {
                    $error='抱歉，您的一卡通现在未能正常登陆，可能的原因是一卡通官网出现问题，请稍后重试，如果 http://www.ecard.ldu.edu.cn 可以访问，但是问题仍在，请联系我的QQ:287578574.';
                }
    			else
                {                   
...
?>
  ...
  <div class="col-md-4"></div>
             ...
             <div class="col-md-4"> <button type="button" class="btn btn-info">温馨提示</button>
                 ...
                 <p><font color="red"><strong>校园一卡通挂失说明：<br>挂失前请谨慎，如需解挂，请到北区一卡通办公室办理<br>如有问题，可联系QQ:287578574.</strong>
      </font>
</p>
</div>
  <div class="col-md-4"></div>
